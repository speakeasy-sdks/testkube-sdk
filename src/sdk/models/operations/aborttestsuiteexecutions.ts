...
export class AbortTestSuiteExecutionsRequest extends SpeakeasyBase {
    /**
...
export class AbortTestSuiteExecutionsResponse extends SpeakeasyBase {
    /**
     * no execution found
     */
    ...
    /**
     * problem with aborting test suite execution
     */
    @SpeakeasyMetadata({ elemType: shared.Problem })
